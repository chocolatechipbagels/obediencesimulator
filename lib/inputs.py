...
class PKMNInputs:
   ...
   #originally here there was a massive, cumbersome, terribly-conceived function which accepted inputs from the user on all the following information
   #I was almost done before I realized what an abominable idea it was and proceeded to hardcode the information below
   #there are still some leftovers from that function in the obviously unnecessary and pointless information in the following dictionaries
   #if some madman wants to make a general version of this program for all use cases, you have my sympathies
